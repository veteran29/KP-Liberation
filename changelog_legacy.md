---
title: Changelog · Legacy version
layout: default
---
...
### 0.96 (civ rep release)

#### [0.963a-Hotfix3](https://github.com/KillahPotatoes/KP-Liberation/releases/tag/v0.963a-Hotfix3)
...
#### 0.963a-Hotfix2
* Fixed: BI Revive wasn't enabled when ACE medical was not present.
...
### 0.95 (logistics release)

#### [0.955](https://github.com/KillahPotatoes/KP-Liberation/releases/tag/v0.955) (24th June 2017)
